...
--
-- Host: 185.100.233.81    Database: kyc_production
-- ------------------------------------------------------
...
CREATE TABLE `kyc_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1786 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
-- Dump completed on 2025-07-23  2:08:37
