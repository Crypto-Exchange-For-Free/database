...
--
-- Table structure for table `withdraw_tracking`
--

DROP TABLE IF EXISTS `withdraw_tracking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `withdraw_tracking` (
  ...
  `transfer` text,
  `ethfee` text,
  `peatio_withdraw` text,
  `other_error` text,
  `status` varchar(45) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`tracking_id`)
) ENGINE=InnoDB AUTO_INCREMENT=27391 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2025-07-23  2:06:21
